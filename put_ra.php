...
echo 'Hello, this is the Regnum Rankingarchive Cronjob for Server Ra.';
...
foreach (Ranking::$REALMS as $realmId => $realmName) {
	foreach (Ranking::$CLASSES as $classId => $className) {
		...
		$url = "http://www.championsofregnum.com/index.php?l=1&ref=gmg&sec=19&rank=2&world=0&realm=$realmId&class=$classId&range=2";
